...
async function starts() {
	...
	client.on('qr', () => {
		console.log(color('[','white'), color('!','red'), color(']','white'), color(' Subrek YT DWYTAMZZ FF'))
	})

	fs.existsSync('./Tamzzz.json') && client.loadAuthInfo('./Tamzzz.json')
	...
	await client.connect({timeoutMs: 30*1000})
        fs.writeFileSync('./Tamzzz.json', JSON.stringify(client.base64EncodedAuthInfo(), null, '\t'))
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			switch(command) {
               ...
               client.sendMessage(from, 'Nah Ini Nomor Bos Owner Aku Jgn Di Spam Ya Nanti Bot Blok Kamu🚼:*',MessageType.text, { quoted: mek} )
                break
				/*case 'loli':
